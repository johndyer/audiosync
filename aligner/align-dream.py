...
def align(argv):
    ...
    timings_file = __dir__ + '/data/dream/dream.json'
    mp3_file = __dir__ + '/data/dream/dream.mp3'
    wav_file = __dir__ + '/data/dream/dream.wav'
    ...
    f.write('../data/dream/dream.txt ../data/dream/dream.wav')
    f.close()	
